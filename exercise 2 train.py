...
for index, row in df.iterrows():
    docKeywords = [s for s in countries if s in row['tokenized_article']]
    docKeywords.append(row['date'])
    docKeywords.append(row['url'])
    taggedDocs.append(
        gensim.models.doc2vec.TaggedDocument(words=row['tokenized_article'],
                                             tags=docKeywords))
df['Tagged'] = taggedDocs
D2V = gensim.models.doc2vec.Doc2Vec(df['Tagged'], vector_size=100)
D2V.save('D2V')
